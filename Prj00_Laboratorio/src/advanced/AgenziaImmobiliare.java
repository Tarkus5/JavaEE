...
public class AgenziaImmobiliare {
	...
	public static void main(String[] args) {
		...
		List<Casa> immobili = new ArrayList<>();
//		Set<Casa> immobiliSet = new HashSet<>();
...
//		Set<Casa> immobiliSet = new HashSet<>(immobili);
		...
		//ComparatoreSuperficie cs = new ComparatoreSuperficie();
